...
class Student(models.Model):
    ...
    target=models.IntegerField('申请目标',max_length=1,choices=TARGET)
    def __str__(self):
...
class Education(models.Model):
    ...
    degree=models.IntegerField('学历/学位',max_length=1,choices=DEGREE)
...
class Scholarship(models.Model):
    student=models.ForeignKey('Strudent')
    date=models.DateField('日期')
